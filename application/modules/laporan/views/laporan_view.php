        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div>
                        <div class="text-left">
                            <button class="btn btn-custom btn-default waves-effect waves-light"
                                onclick="input_kegiatan()"><i class="fa fa-plus"></i> Tambah Pemasukan </button>
                            <button class="btn btn-custom btn-default" onclick="reload_table()"><i
                                    class="fa fa-refresh"></i> Reload
                                Data</button>
                        </div>
                        <br>
                        <h4><b>Filter Menurut</b></h4>
                        <div class="text-left">
                            <button class="btn btn-custom btn-default waves-effect waves-light"
                                onclick="input_kegiatan()"><i class="fa fa-plus"></i> Zakat </button>
                            <button class="btn btn-custom btn-default waves-effect waves-light"
                                onclick="input_kegiatan()"><i class="fa fa-plus"></i> Infaq </button>
                            <button class="btn btn-custom btn-default waves-effect waves-light"
                                onclick="input_kegiatan()"><i class="fa fa-plus"></i> Sadaqah </button>
                            <button class="btn btn-custom btn-default waves-effect waves-light"
                                onclick="input_kegiatan()"><i class="fa fa-plus"></i> Waqaf </button>
                            <button class="btn btn-custom btn-default waves-effect waves-light"
                                onclick="input_kegiatan()"><i class="fa fa-plus"></i> Lain - Lain </button>
                        </div>
                        ...
                        <button type="button" class="btn btn-primary" id="kirim">Filter</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#kirim').click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= site_url('laporan/ajax_list') ?>',
                dataType: 'json',
                data: {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="filestyle" name="gambar" data-buttontext="Pilih File"
                                    data-placeholder="Upload Gambar" data-buttonname="btn-info">
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" onclick="reload_page()" class="btn btn-default waves-effect"
                    data-dismiss="modal">Close</button>
                <a onclick="$.Notification.notify('success','top left', 'Sukses', 'Data Berhasil Dimasukkan.')"><button
                        type="button" id="btnSave" onclick="save()" class="btn btn-info waves-effect waves-light">Simpan
                        Kegiatan</button></a>
            </div>
        </div>
        </form>
