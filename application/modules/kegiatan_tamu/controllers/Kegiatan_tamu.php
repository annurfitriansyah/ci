...
class Kegiatan_tamu extends CI_Controller{
    function __construct(){
        parent::__construct();
        $this->load->model('kegiatan_tamu_model');
    ...
    function index(){
        ...
        $data = array(
            ...
            $this->theme_guest->load('kegiatan_tamu_view', $data);
    ...
    public function ajax_list(){
		...
		$list = $this->kegiatan_tamu_model->get_datatables();
		$data = array();
        $no = 1;
		...
		$output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->kegiatan_tamu_model->count_all(),
                        "recordsFiltered" => $this->kegiatan_tamu_model->count_filtered(),
                        "data" => $data,
                );
    ...
    {
        $data = $this->kegiatan_tamu_model->get_kegiatan_by_id($id);
        echo json_encode($data);
    }

	function tampil_kegiatan(){
        $data = $this->kegiatan_tamu_model->kegiatan_list();
