...
<body class="fixed-left">
    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    ...
                    <!--Image Logo here -->
                    <a href="<?= base_url('awal_admin'); ?>" class="logo"><i class="icon-c-logo">
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                             <li class="dropdown top-menu-item-xs">
                                <a href="" class="dropdown-toggle profile waves-effect waves-light"
                                    ...
                                    <span class="text-capitalize" ><?= $nama;?></span>
                                    <img src="<?= base_url('uploads/user/'.$gambar);?>" alt="user-img" class="img-circle"> </a>
                                <ul class="dropdown-menu">
                                    <li><h3 class="text-center"><?= $level;?></h3></li>
                                            <li class="divider"></li>
                                    <li><a href="http://localhost/CI/profil"><i class="ti-user m-r-10 text-custom"></i>
                                            Profile</a></li>
                                            <li class="divider"></li>
        ...
        <!-- ========== Left Sidebar Start ========== -->
        <?=$this->load->view('templates/front_menu_admin'); ?>
        <!-- Left Sidebar End -->
